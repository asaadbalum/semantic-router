...
def data_collator(features):
    ...
    batch = {
        ...
        'clean_attention_mask': torch.stack([f['clean_attention_mask'] for f in features]),
        'typo_input_ids': torch.stack([f['typo_input_ids'] for f in features]),
        'typo_attention_mask': torch.stack([f['typo_attention_mask'] for f in features]),
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Consistency Training for Typo Robustness")
